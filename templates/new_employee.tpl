...
<input type="hidden" name="section" value="save_employee">
<table class="table">
<tr>
	<td>Employee First Name:</td><td><input type="text" name="employee" size="30" required></td>
	<td>Middle Name:</td><td><input type="text" name="middle" size="30"></td>
</tr>
<tr>
	<td>Last Name:</td><td><input type="text" name="last" size="30" required></td>
</tr>

	<td>S.S.N:</td><td><input type="password" name="ssn" id="ssn" size="30" required onkeypress="return isNumber(event)" placeholder="Numbers Only"></td>
	<td>Verify S.S.N:</td><td><input type="password" name="ssn2" id="ssn2" size="30" required onchange="check_ssn()" placeholder="Numbers Only"></td>
</tr>
<tr>
	<td>Gender:</td><td><select name="gender" required><option value="">--Select--</option><option>Male</option><option>Female</option></select></td>
</tr>
<tr>
	<td>Pay Frequency:</td><td><select name="pay_frequency" required><option value="">--Select--</option><option>Weekly</option><option>Bi Weekly</option><option>Monthly</option></select></td>
	<td>Annual Salary:</td><td>$<input type="text" name="annual_salary" size="30" required placeholder="Numbers only" onkeypress="return isNumber(event)"></td>
</tr>
<tr>
	<td>Hourly Rate:</td><td>$<input type="text" name="hourly_rate" size="30" required placeholder="example 24.50"</td>
	<td>W-4 Marital Status:</td><td><input type="text" name="w4_marital" size="30" required></td>
</tr>
<tr>
	<td>W-4 Dependents:</td><td><input type="text" name="w4_dependents" size="30" required></td>
	<td>Total Health Monthly Premium:</td><td><input type="text" name="health_monthly_premium" size="30"></td>
</tr>
<tr>
	<td>Employer Monthly Contribution:</td><td><input type="text" name="employer_monthly_contribution" size="30"></td>
	<td>PreTax Premium Monthly Total:</td><td><input type="text" name="pretax_premium_monthly" size="30"></td>
</tr>
<tr>
	<td>H.S.A.:</td><td><input type="text" name="hsa" size="30"></td>
	<td>Personal Email:</td><td><input type="text" name="email" size="30" required></td>
</tr>
<tr>
	<td>Mobile Phone:</td><td><input type="text" name="mobile" size="30"></td>
	<td>Address:</td><td><input type="text" name="address" size="30" required></td>
</tr>
<tr>
	<td>City:</td><td><input type="text" name="city" size="30" required></td>
	<td>State:</td><td><select name="state" id="state" required>{$states}</td>
</tr>
<tr>
	<td>Zip Code:</td><td><input type="text" name="zip" size="30" required></td>
	<td>Full Time:</td><td><select name="full_time"><option>Yes</option><option>No</option></select></td>
</tr>
<tr>
...
<tr id="ok"><td colspan="4"><input type="submit" class="btn btn-primary" value="Save Employee">&nbsp;&nbsp;<input type="button" value="Cancel" class="btn btn-warning" onclick="document.location.href='employer.php'"></td></tr>
